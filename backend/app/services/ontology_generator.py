...
Interface 1: Analyze text content and generate entity and relation type definitions suitable for social simulation
"""
...
A. **Fallback types (must include, place at the last 2 positions in the list)**:
   - `Person`: Fallback type for any individual person. When a person doesn't fit other more specific person types, classify them here.
   - `Organization`: Fallback type for any organization. When an organization doesn't fit other more specific organization types, classify them here.
...
- Various people will appear in the text, such as "elementary school teachers", "passersby", "anonymous netizens"
...
- Ensure the source_targets of relations cover the entity types you defined
...
- Person: Any individual (use when not fitting the above specific types)
...
class OntologyGenerator:
    """
    Ontology Generator
    Analyze text content and generate entity and relation type definitions
    本体生成器
    分析文本内容，生成实体和关系类型定义
    """
