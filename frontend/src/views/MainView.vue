  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/dashboard')"><span class="brand-icon">🐟</span> FISH PREDICTIONS</div>
      </div>
...
const stepNames = ['Graph Building', 'Environment Setup', 'Run Simulation', 'Generate Report', 'Deep Interaction']
